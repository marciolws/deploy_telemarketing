...
def main():
    ...
    <div style="text-align:center">
        <a href="https://github.com/marciolws/EBAC_EXERCICIO">
    ...
    **Data:** 12 de outubro de 2024.
    ...
    st.sidebar.markdown(
        body='<img src="https://raw.githubusercontent.com/marciolws/EBAC_EXERCICIOS/refs/heads/main/Módulo%2019%20-%20Streamlit%20II/data/Bank-Branding.jpg" width=100%>',
        unsafe_allow_html=True,
    )
    ...
    if data_file_1 is not None:
        ...
        bank_raw = load_data(
            # file_data="https://raw.githubusercontent.com/marciolws/EBAC_EXERCICIOS/refs/heads/main/Módulo%2019%20-%20Streamlit%20II/data/bank-additional-full.csv",
        ...
        # Coluna 2
        bank_target_pct = bank["y"].value_counts(
        ...
        if graph_type == "Barras":
            ...
            bank_target_pct.plot(kind="pie", autopct="%.2f",
                                 y="proportion", ax=axes[1])
